...
- **"Your Stories" section**:
  ...
  - **Play button**: fetches world progress to resume from last node (see `getWorldProgress` in `src/lib/api/nodes.ts`)
...
#### Story Node Reader (`/worlds/[worldId]/nodes/[nodeId]`)
> **Page**: `src/routes/worlds/[worldId]/nodes/[nodeId]/+page.svelte`
...
#### Story Map (`/worlds/[worldId]/graph`)
> **Page**: `src/routes/worlds/[worldId]/graph/+page.svelte`
...
> **Node queries**: `src/lib/queries/nodes.ts` (`useWorldNodes`)
